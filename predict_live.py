"""
Real-Time ECG Classification Demo
---------------------------------
Simulates live ECG monitoring with real-time predictions.

Portfolio highlight: Shows complete ML pipeline in action.
"""
...
# IMPORTANT FIX: feature names must be strings
feature_names = (
...
def predict_single(signal):
    ...
    # 🔧 CRITICAL FIX — align features safely
